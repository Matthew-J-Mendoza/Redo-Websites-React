...
let listArr = ['• Offset Printing','• Die Cutting','• Foiling','• Letterpress','• Embossing','• Wide Format Printing','• 4 Color Digital Printing','• Booklet Making','• Variable Data and Mailings'].map(item=> <p>{item}</p>)
